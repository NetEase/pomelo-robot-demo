	...
	<div id="container">
		...
		<div id="right">
			...
			<div class="screen history" id="history_template2">
				...
				<div class="console">
					<div class='dspan'>
						...
						<div style="">
							<div class="" style="float: left" id="" style="">Per Agent Users：<input type='text' style="width:120px" value='50' id="maxuserinput" /></div>
							<div> &nbsp;&nbsp;</div>
						</div>
					</div>
					<div class='dspan'>
			...
			<div class="screen history" id="summary_div2">
				<div class="bar">
					...
					<div class="bar-top-right">
						<div class="screen-buttons">
							<input type="button" class="add-button" id='sumbtn' value='ShowDetail'>&nbsp;<img style='display:none' id='table_img'
				...
				<div class="bar">
					...
					<div class="bar-top-right">
						<div class="screen-buttons"><input type="button" class="add-button"
									id='avgbtn' value='ShowDetail'>&nbsp;<img id='avg_img'  style='display:none'
								src="/images/icons/cross.png" title="Close Screen" />
						</div>
						<div class="screen-search">
							<a href="#" class="result-count"></a>
			...
			<div class="screen history" id="qs_div2" style="height:246px">
				<div class="bar">
					<span class="screen-label">Qps Graph</span>
					<div class="bar-top-right">
						<div class="screen-buttons"><input type="button" class="add-button"
									id='qsbtn' value='ShowDetail'>&nbsp;<img id='qs_img'  style='display:none'
								src="/images/icons/cross.png" title="Close Screen" />
						</div>
						<div class="screen-search">
							<a href="#" class="result-count"></a>
		...
		<div id="templates">
			...
			<div class="screen history" id="avg_template" style="height:246px;">
				<div class="bar">
					<span class="screen-label">Request Time Graph</span>
					<div class="bar-top-right">
						<div class="screen-buttons">
							<a class="button" href="#"></a>
						</div>
